...
app.get('/search', function(req, res){
	...
	var empty = "Nothing found. Please try a different search."
if (searchTerm in data.programming) {
		res.send(data.programming[searchTerm])
	} else if (searchTerm in data['search engines']) {
		res.send(data['search engines'][searchTerm])
	} else {
	//res.send("the var empty")
} 
